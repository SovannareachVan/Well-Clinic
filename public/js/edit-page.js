...
const editTelegram = document.getElementById("editTelegram"); // Add Telegram field
...
async function loadPatientData() {
    ...
    try {
        ...
        if (snapshot.exists()) {
            ...
            editTelegram.value = patientData.telegram || ""; // Load Telegram field
...
editPatientForm.addEventListener("submit", async (event) => {
    ...
    try {
        const updatedData = {
            ...
            telegram: editTelegram.value.trim() || "", // Save Telegram field
