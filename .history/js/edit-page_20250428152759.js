    ...
    try {
        ...
        if (snapshot.exists()) {
            ...
            if (patientData.address) {
                ...
                // Set selected value for each address dropdown
                setSelectedValue(village, village, "village");
                setSelectedValue(commune, commune, "commune");
                setSelectedValue(district, district, "district");
                setSelectedValue(province, province, "province");
            }
        } else {
