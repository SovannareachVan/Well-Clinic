...
function positionDropdown(input, dropdown) {
    ...
    // Prefer positioning below the input if there is enough space
    if (spaceBelow >= dropdownHeight) {
        dropdown.style.top = `${inputRect.bottom + window.scrollY}px`;
        dropdown.style.bottom = 'auto';
    } else if (spaceAbove >= dropdownHeight) {
        // Position above the input if there isn't enough space below
        dropdown.style.top = 'auto';
        dropdown.style.bottom = `${viewportHeight - inputRect.top + window.scrollY}px`;
    } else {
        // If neither has enough space, prioritize below and allow scrolling within dropdown
        dropdown.style.top = `${inputRect.bottom + window.scrollY}px`;
        dropdown.style.bottom = 'auto';
    }
...
function positionDropdown(input, dropdown) {
    ...
    // Set left position to align with the input
    dropdown.style.left = `${inputRect.left + window.scrollX}px`;
    dropdown.style.width = `${inputRect.width}px`; // Match the input width
