    ...
    try {
      ...
      if (snapshot.exists()) {
        ...
        document.getElementById('patientNotes').innerHTML = `
          <div class="note-item"><strong>1. Symptoms:</strong> ${notes.note1 || 'N/A'}</div>
          <div class="note-item"><strong>2. Treatment History:</strong> ${notes.note2 || 'N/A'}</div>
          <div class="note-item"><strong>3. Lab Tests:</strong> ${notes.note3 || 'N/A'}</div>
