...
function populateNote4Dropdown() {
    const note4Options = ["Cat", "Car", "Apple", "Fruit", "Banana", "Grapes", "Orange"]; // Example list, can be dynamic
    const datalist = document.getElementById('note4-options');

    // Clear existing options
    datalist.innerHTML = "";

    // Loop through and create options dynamically
    note4Options.forEach(optionValue => {
