...
const addressOptions = {
    ...
    provinces: [
        { value: "Province 1", label: "រាជធានី ភ្នំពេញ" },
        { value: "Province 2", label: "ខេត្ត បន្ទាយមានជ័យ" },
        { value: "Province 3", label: "ខេត្ត បាត់ដំបង" },
        { value: "Province 4", label: "ខេត្ត កំពង់ចាម" },
        { value: "Province 5", label: "ខេត្ត កំពង់ឆ្នាំង" },
        { value: "Province 6", label: "ខេត្ត កំពង់ស្ពឺ" },
        { value: "Province 7", label: "ខេត្ត កំពង់ធំ" },
        { value: "Province 8", label: "ខេត្ត កំពត" },
        { value: "Province 9", label: "ខេត្ត កណ្តាល" },
        { value: "Province 10", label: "ខេត្ត កែប" },
        { value: "Province 11", label: "ខេត្ត កោះកុង" },
        { value: "Province 12", label: "ខេត្ត ក្រចេះ" },
        { value: "Province 13", label: "ខេត្ត មណ្ឌលគិរី" },
        { value: "Province 14", label: "ខេត្ត អូរដែរមានជ័យ" },
        { value: "Province 15", label: "ខេត្ត ប៉ៃលិន" },
        { value: "Province 16", label: "ខេត្ត ព្រះវិហារ" },
        { value: "Province 17", label: "ខេត្ត ព្រៃវែង" },
        { value: "Province 18", label: "ខេត្ត ពោធិ៍សាត់" },
        { value: "Province 19", label: "ខេត្ត រតនគិរី" },
        { value: "Province 20", label: "ខេត្ត សៀមរាប" },
        { value: "Province 21", label: "ខេត្ត ព្រះសីហនុ" },
        { value: "Province 22", label: "ខេត្ត ស្ទឹងត្រែង" },
        { value: "Province 23", label: "ខេត្ត ស្វាយរៀង" },
        { value: "Province 24", label: "ខេត្ត តាកែវ" },
        { value: "Province 25", label: "ខេត្ត ត្បូងឃ្មុំ" }
    ]
