...
function addMedicineItem() {
    ...
    // Create table structure similar to your image
    const tableHTML = `
    <table class="medicine-table">
        <thead>
            <tr>
                <th>ผู้ขาดซี</th>
                <th>หมูบนชิญกลั่ง</th>
                <th>มอง:ถกจ</th>
                <th>กี๊ค ไซ่ แท่</th>
                <th>อัตราซี</th>
                <th></th>
            ...
            <tr>
                ...
                <td>
                    <select class="dosage-select">
                        ...
                        <!-- Add more dosage options here -->
                    </select>
                </td>
                <td>
                    <input type="text" class="morning-input" placeholder="เช้า">
                </td>
                <td>
                    <div class="checkbox-group">
                        <input type="checkbox" id="beforeMeal">
                        <label for="beforeMeal">ก่อนอาหาร</label>
                        <input type="checkbox" id="afterMeal">
                        <label for="afterMeal">หลังอาหาร</label>
                    </div>
                </td>
                <td>
