        ...
        if (patientSnapshot.exists()) {
            ...
            if (patientData.address) {
                const addressParts = [
                    ...
                    patientData.address.commune ? `ឃុំ ${patientData.address.commune}` : '',
                    patientData.address.district ? `ស្រុក ${patientData.address.district}` : '',
                    patientData.address.province ? `ខេត្ត ${patientData.address.province}` : ''
