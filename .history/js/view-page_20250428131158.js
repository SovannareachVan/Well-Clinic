...
async function getPatientDetails(recordId, visitId = null) {
    ...
    try {
        ...
        if (patientData.address) {
            const addressParts = [
                translateAddressPart(patientData.address.village),
                translateAddressPart(patientData.address.commune),
                translateAddressPart(patientData.address.district),
                translateAddressPart(patientData.address.province)
