...
const medicineOptions = [
    ...
    "DV-LEO", "DV-Lopram", "Euphytose", "Eziness 30mg", "Haloperidol 10mg", "Lamnet 25mg",
    "Lamnet 50mg", "Lamnet 100mg", "Lanzap 2.5mg", "Lanzap 5mg", "Lanzap 10mg",
    "Lumark 500mg", "Merlopam 0.5mg", "Merlopam 2mg", "Morcet 10mg", "MultiV",
    "Nortriptyline 25mg", "Perphenazine 8mg", "Persidal 2mg", "Phenobarbitale 100mg",
    "Phenobarbitale 50mg", "Polytanol 25mg", "Ratraline 50mg", "Rismek 2mg",
    "Sertaline 50mg", "Thioridazine 10mg", "Trihexyphenidule 8mg", "Valdoxan 25mg",
    "Carbamazepine 200mg", "Zoloft 50mg"
];
    ...
    if (patientId && visitId) {
        try {
            ...
            if (snapshot.exists()) {
                ...
                // Try to load from initialData if no visit info exists
                const initialRef = ref(db, `patients/${patientId}/initialData`);
                const initialSnapshot = await get(initialRef);
                if (initialSnapshot.exists()) {
                    patientInfo = initialSnapshot.val();
                } else {
                    patientInfo = { medicines: [] };
                }
            }
