    ...
    window.addMedicineItem = function (medicineData = null) {
        ...
        // Helper: Convert values like "1+1/2" or "1/2" to numbers
        ...
        // If medicine data provided, fill in the fields
        if (medicineData) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (recordId) {
            ...
            // ✅ Automatically create the first row when the page loads
            addMedicineItem();  // <-- Add this line
        }
