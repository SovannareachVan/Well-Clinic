...
if (!patientId) {
    medicinesTableBody.innerHTML = "<tr><td colspan='2'>Patient ID is required. Please use ?patientId=... in the URL.</td></tr>";
    return;
}
...
medicineForm.addEventListener("submit", (e) => {
    ...
    if (!patientId) {
        alert("Cannot add medicine: Patient ID is undefined.");
        return;
    }
