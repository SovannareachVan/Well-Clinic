...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (patientId && visitId) {
        try {
            ...
            if (snapshot.exists()) {
                ...
                if (patientSnapshot.exists()) {
                    ...
                    // Debug: Check entire patient node for more information
                    ...
                    addMedicineItem(null, true); // Ensure at least one medicine item is available
                }
            }
        } catch (error) {
            console.error('Error loading patient information:', error);
            alert('កំហុសក្នុងការផ្ទុកព័ត៌មាន៖ ' + error.message);
            addMedicineItem(null, true); // Fallback to add a default item
        }
    } else {
        ...
        addMedicineItem(null, true); // Ensure UI is usable
    }
