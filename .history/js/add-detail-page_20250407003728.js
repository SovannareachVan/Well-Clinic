...
// Function to display notes properly
function displayNotes(notes) {
    ...
    if (notes.original) {
        ...
        notesContainer.textContent = JSON.stringify(notes);
    }
}

// In your getPatientDetails function, replace:
...
async function getPatientDetails(recordId) {
    try {
        ...
        if (snapshot.exists()) {
            ...
            // Load structured notes if they exist
            if (patientData.notes && typeof patientData.notes === 'object' && patientData.notes.structured) {
                const structured = patientData.notes.structured;
