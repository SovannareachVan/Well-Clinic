...
async function savePatientInformation() {
    // Add your actual logic to save the data to Firebase or perform any necessary actions
    console.log('Saving patient information...');
    // Simulating a save operation
    return new Promise(resolve => setTimeout(resolve, 1000));  // Simulating save delay (1 second)
}
...
function initDiagnosisDropdown() {
    ...
    // Initialize your dropdown logic
}
