...
// Function to initialize medicine dropdown with dynamic positioning
function initMedicineDropdown(parentElement) {
    ...
    input.addEventListener('click', function (event) {
        ...
        // Dynamically position the dropdown
        const inputRect = input.getBoundingClientRect();
        const dropdownHeight = 200; // Max height of the dropdown (as set in CSS)
