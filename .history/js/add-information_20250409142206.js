...
async function savePatientNotes(recordId) {
    try {
        ...
        // Prepare update data - preserve existing structure
        const updateData = {
            ...patientData, // Keep all existing data
            structuredNotes: {
                ...(patientData.structuredNotes || {}), // Keep existing structured notes
                ...notes // Add/update our notes
            },
            lastUpdated: new Date().toISOString() // Add timestamp
        };

        // Save to Firebase
        await update(ref(db, 'patients/' + recordId), updateData);
        
        alert('Notes saved successfully!');
        // Optional: reload the data to confirm save
