...
const addressMapping = {
    ...
    province: {
        ...
        "Province 3": "ក្អាត់",
        "Province 4": "ភ្នំពេញ",
        "Province 5": "បន្ទាយមានជ័យ",
        "Province 6": "បាត់ដំបង",
        "Province 7": "កំពង់ចាម",
        "Province 8": "កំពង់ឆ្នាំង",
        "Province 9": "កំពង់ស្ពឺ",
        "Province 10": "កំពង់ធំ",
        "Province 11": "កំពត",
        "Province 12": "កណ្តាលស្ទឹង",
        "Province 13": "កោះកុង",
        "Province 14": "ក្រចេះ",
        "Province 15": "មណ្ឌលគីរី",
        "Province 16": "អូររ៉ាល់",
        "Province 17": "ពោធិ៍សាត់",
        "Province 18": "ព្រែកសែ",
        "Province 19": "ព្រះវិហារ",
        "Province 20": "ព្រៃវែង", // already included
        "Province 21": "ព្រះសីហនុ",
        "Province 22": "រតនគីរី",
        "Province 23": "សៀមរាប",
        "Province 24": "ស្ទឹងត្រែង",
        "Province 25": "តាកែវ"
    }
