...
async function getPatientDetails(recordId) {
    try {
        ...
        if (snapshot.exists()) {
            ...
            // Populate the details (do not overwrite)
            ...
            document.getElementById('note1').value = patientData.notes?.note1 || '';
            document.getElementById('note2').value = patientData.notes?.note2 || '';
            document.getElementById('note3').value = patientData.notes?.note3 || '';
            document.getElementById('note4').value = patientData.notes?.note4 || '';
            document.getElementById('note5').value = patientData.notes?.note5 || '';
            document.getElementById('note6').value = patientData.notes?.note6 || '';
        } else {
