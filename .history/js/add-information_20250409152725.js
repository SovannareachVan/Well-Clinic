...
function initDiagnosisDropdown() {
    const input = document.getElementById('noteDiagnosis');
    const dropdown = document.getElementById('noteDiagnosis-dropdown');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.addEventListener('click', function (event) {
            const noteDiagnosisDropdown = document.getElementById('noteDiagnosis-dropdown');
            const noteDiagnosisInput = document.getElementById('noteDiagnosis');
            if (noteDiagnosisDropdown && noteDiagnosisInput && !noteDiagnosisInput.contains(event.target) && !noteDiagnosisDropdown.contains(event.target)) {
                noteDiagnosisDropdown.style.display = 'none';
            }
        });
    });
