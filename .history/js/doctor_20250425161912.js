...
window.deletePatient = function (patientId) {
    const password = prompt("Enter password to delete patient:");
...
// Function to add patient details (placeholder for now)
window.addPatientDetail = function (patientId) {
    window.location.href = `add-detail-page.html?id=${patientId}`; // Redirect to add detail page
};
