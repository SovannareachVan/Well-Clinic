...
async function savePatientNotes(recordId) {
    ...
    const structuredNotes = {
        note1: document.getElementById('patientNote1').value,
        note2: document.getElementById('patientNote2').value,
        note3: document.getElementById('patientNote3').value,
        note4: document.getElementById('patientNote4').value,
        note5: document.getElementById('patientNote5').value,
        medicines
    };
    ...
    try {
        ...
        alert('Patient notes updated successfully!');
    } catch (error) {
