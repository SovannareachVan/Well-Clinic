...
function initMedicineDropdown(parentElement) {
    ...
    input.addEventListener('input', function () {
        ...
        // Position and show the dropdown with a delay
...
function positionDropdown(input, dropdown) {
    // Reset position to avoid initial offset
    ...
    // Apply the position and show the dropdown after a slight delay
    setTimeout(() => {
    ...
    console.log('Input Top:', inputTop, 'Input Bottom:', inputBottom, 'Input Left:', inputLeft);
    console.log('Space Below:', spaceBelow, 'Space Above:', spaceAbove);
    console.log('Dropdown Top:', dropdown.style.top, 'Dropdown Left:', dropdown.style.left);
}
