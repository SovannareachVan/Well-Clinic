...
function positionDropdown(input, dropdown) {
    ...
    // Set the left position to align with the input
    dropdown.style.left = `${inputLeft}px`;
    dropdown.style.width = `${inputRect.width}px`; // Match the input width
    ...
    console.log('Input Top:', inputTop, 'Input Bottom:', inputBottom);
    console.log('Space Below:', spaceBelow, 'Space Above:', spaceAbove);
    console.log('Dropdown Top:', dropdown.style.top);
}
