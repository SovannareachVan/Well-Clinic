    ...
    try {
        ...
        if (visitId) {
            ...
            if (visitIndex === -1) {
                ...
                visitId = visits.length > 0 ? visits[0][0] : null;
            }
            if (visitId) {
                ...
                const isFirstVisit = visitIndex === 0 || visitIndex === undefined;
                const visitNumber = visitIndex !== -1 ? visitIndex + 1 : 1;
...
function isValidDate(dateStr) {
    ...
    // Relaxed validation to handle Firebase format
