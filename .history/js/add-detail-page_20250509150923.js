...
async function getPatientDetails(recordId, visitId = null) {
    try {
        ...
        // Address Mapping (same logic like view-page and date-register-page)
    ...
    async function savePatientNotes(recordId, visitId = null) {
        ...
        const structuredNotes = {
            ...
            note4: document.getElementById('patientNote4').value.trim(), // Diagnosis
            note5: document.getElementById('patientNote5').value.trim(),
            medicines,
            // Add these new fields
            initialDiagnosis: document.getElementById('patientNote4').value.trim(),
