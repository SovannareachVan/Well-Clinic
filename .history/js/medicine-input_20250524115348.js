...
const patientId = urlParams.get("patientId"); // Changed from "id" to "patientId"
if (!patientId) {
...
function initializeMedicines() {
    ...
    onValue(medicinesRef, (snapshot) => {
        if (!snapshot.exists()) {
            console.log("Initializing medicines for patientId:", patientId);
            ...
            set(medicinesRef, medicinesToAdd)
                .then(() => console.log("Medicines initialized successfully"))
