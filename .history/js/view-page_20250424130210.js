...
// ... (keep all the existing imports and top-level code the same)
    ...
    return `
        <div class="visit-note">
            ...
            <div class="visit-note-content">
                ...
                <div class="note-item"><strong>រោគវិនិច្ឆ័យញែក:</strong> ${info.note5 || info.detailedDiagnosis || 'មិនទាន់បំពេញ'}</div>
