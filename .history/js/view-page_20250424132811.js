...
function generateInitialVisitHtml(checkIn, checkOut, generalNotes, notes) {
    return `
        <div class="visit-note initial-visit">
            <div class="visit-note-header">
                <h3>ការចុះឈ្មោះដំបូង</h3>
            ...
            <div class="visit-note-content">
                <div class="note-item"><strong>កំណត់សម្គាល់ទូទៅ:</strong> ${generalNotes}</div>
                
                <!-- Medical Details from add-detail-page.js -->
                ...
                ${notes.medicines?.length > 0 ? `
                    ...
                    ${generateMedicineTable(notes.medicines)}
                ` : ''}
            </div>
        </div>
    `;
    ...
    return `
        <div class="visit-note follow-up-visit">
            ...
            <div class="visit-note-content">
                ...
                <div class="note-item"><strong>សញ្ញាណតម្អូញ:</strong> ${info.symptoms || 'មិនទាន់បំពេញ'}</div>
