...
window.addMedicineItem = function (medicineData = null) {
        ...
        <table class="medicine-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="number" class="quantity-input" readonly></td>
                    <td><button class="remove-item-btn">លុប</button></td>
                </tr>
            </tbody>
        </table>
    `;
    ...
    // Initialize the medicine dropdown and event listeners
