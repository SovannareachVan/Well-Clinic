...
const diagnosisOptions = [
    "ជំងឺគ្រុនចាញ់", "ជំងឺគ្រុនចាញ់ធ្ងន់ធ្ងរ", "ជំងឺគ្រុនឈាម", 
    "ជំងឺរលាកបំពង់ក", "ជំងឺរលាកសួត", "ជំងឺហឺតៗ", "ជំងឺផ្តាសាយ", 
    "ជំងឺគ្រុនក្តៅ", "ជំងឺរលាកពោះវៀន", "ជំងឺរលាកក្រពះ", 
    "ជំងឺរលាកសួតធ្ងន់ធ្ងរ", "ជំងឺមហារីក", "ជំងឺស្វាយ", 
    "ជំងឺឆ្កួតជ្រូក", "ជំងឺហើមសរសៃប្រសាទ", "ជំងឺហើមសរសៃប្រសាទភ្នែក", 
    "ជំងឺមហារីកថ្លើម", "ជំងឺមហារីកពោះវៀន", "ជំងឺមហារីកសួត", 
    "ជំងឺមហារីកឈាម"
];

const medicineOptions = [
    "Paracetamol 500mg", "Amoxicillin 500mg", "Ibuprofen 400mg", "Cetirizine 10mg", 
    "Loratadine 10mg", "Omeprazole 20mg", "Metronidazole 500mg", "Ciprofloxacin 500mg", 
    "Doxycycline 100mg", "Azithromycin 250mg", "Prednisolone 5mg", "Furosemide 40mg", 
    "Amlodipine 5mg", "Losartan 50mg", "Metformin 500mg", "Glibenclamide 5mg", 
    "Atorvastatin 20mg", "Simvastatin 20mg", "Salbutamol inhaler", "Beclomethasone inhaler"
];
    ...
    <table class="medicine-table">
        ...
        <tbody>
            <tr>
                ...
                <td><input type="text" class="quantity-input" placeholder="ចំនួន" readonly></td>
                <td><button type="button" class="remove-medicine-btn" onclick="this.closest('li').remove();">Remove</button></td>
            </tr>
        </tbody>
    </table>
    `;
...
window.savePatientData = function() {
    ...
    update(patientRef, patientData).then(() => {
