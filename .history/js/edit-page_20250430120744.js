...
const addressOptions = {
    ...
    provinces: [
        ...
        { value: "ភ្នំពេញ", label: "ខេត្ត ភ្នំពេញ" },
        { value: "បន្ទាយមានជ័យ", label: "ខេត្ត បន្ទាយមានជ័យ" },
        { value: "បាត់ដំបង", label: "ខេត្ត បាត់ដំបង" },
        { value: "កំពង់ចាម", label: "ខេត្ត កំពង់ចាម" },
        { value: "កំពង់ឆ្នាំង", label: "ខេត្ត កំពង់ឆ្នាំង" },
        { value: "កំពង់ស្ពឺ", label: "ខេត្ត កំពង់ស្ពឺ" },
        { value: "កំពង់ធំ", label: "ខេត្ត កំពង់ធំ" },
        { value: "កំពត", label: "ខេត្ត កំពត" },
        { value: "កោះកុង", label: "ខេត្ត កោះកុង" },
        { value: "ក្រចេះ", label: "ខេត្ត ក្រចេះ" },
        { value: "មណ្ឌលគីរី", label: "ខេត្ត មណ្ឌលគីរី" },
        { value: "ពោធិ៍សាត់", label: "ខេត្ត ពោធិ៍សាត់" },
        { value: "ព្រះវិហារ", label: "ខេត្ត ព្រះវិហារ" },
        { value: "ព្រះសីហនុ", label: "ខេត្ត ព្រះសីហនុ" },
        { value: "រតនគីរី", label: "ខេត្ត រតនគីរី" },
        { value: "សៀមរាប", label: "ខេត្ត សៀមរាប" },
        { value: "ស្ទឹងត្រែង", label: "ខេត្ត ស្ទឹងត្រែង" },
        { value: "តាកែវ", label: "ខេត្ត តាកែវ" },
        { value: "ស្វាយរៀង", label: "ខេត្ត ស្វាយរៀង" },
        { value: "ឧត្តរមានជ័យ", label: "ខេត្ត ឧត្តរមានជ័យ" },
        { value: "កែប", label: "ខេត្ត កែប" },
        { value: "ប៉ៃលិន", label: "ខេត្ត ប៉ៃលិន" },
        { value: "ត្បូងឃ្មុំ", label: "ខេត្ត ត្បូងឃ្មុំ" }
    ]
