            ...
            const visitHtml = `
                <div class="visit-note">
                    ...
                    <div class="visit-note-content">
                                        <div class="note-item"><strong>1. សញ្ញាណតម្អូញ:</strong> ${initialNotes.note1 || 'មិនទាន់បំពេញ'}</div>                        <div class="note-item"><strong>ប្រវត្តិព្យាបាល:</strong> ${info.note2 || info.treatmentHistory || 'មិនទាន់បំពេញ'}</div>
