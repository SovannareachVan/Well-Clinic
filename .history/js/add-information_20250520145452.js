...
function positionDropdown(input, dropdown) {
    ...
    // Calculate the available space below and above the input
    ...
    // Prioritize positioning below the input if possible
    if (spaceBelow >= dropdownHeight) {
        dropdown.style.top = `${inputRect.bottom + window.scrollY}px`;
        dropdown.style.bottom = 'auto';
    } else if (spaceAbove >= dropdownHeight) {
        // Move above the input if there's not enough space below
        dropdown.style.top = 'auto';
        dropdown.style.bottom = `${viewportHeight - inputRect.top + window.scrollY}px`;
    } else {
        // If neither has enough space, position below and let dropdown scroll internally
        dropdown.style.top = `${inputRect.bottom + window.scrollY}px`;
        dropdown.style.bottom = 'auto';
    ...
    if (inputRect.left + inputRect.width > viewportWidth) {
    ...
    console.log('Dropdown Top:', dropdown.style.top, 'Dropdown Bottom:', dropdown.style.bottom);
}
