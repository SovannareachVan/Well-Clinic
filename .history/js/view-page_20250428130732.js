...
async function getPatientDetails(recordId, visitId = null) {
    ...
    try {
        ...
        if (patientData.address) {
            const addressParts = [];
            if (patientData.address.village) addressParts.push(patientData.address.village);
            if (patientData.address.commune) addressParts.push(patientData.address.commune);
            if (patientData.address.district) addressParts.push(patientData.address.district);
            if (patientData.address.province) addressParts.push(patientData.address.province);
