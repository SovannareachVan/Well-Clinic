...
async function getPatientDetails(recordId, visitId = null) {
    ...
    try {
        ...
        console.log('Patient data:', patientData);  // Add this line for debugging

        const patientNotesContainer = document.getElementById('patientNotes');

        // If visitId is provided, show specific visit details
        ...
        // Default: show all visits or structured notes
        let outputHtml = '';
