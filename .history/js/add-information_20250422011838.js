...
window.addMedicineItem = function(medicineData = null, forceAdd = false) {
    ...
    newRow.classList.add('medicine-item');
    ...
    const daysInput = newRow.querySelector('.time-input');
    const morningSelect = newRow.querySelector('.morning-dose');
    const afternoonSelect = newRow.querySelector('.afternoon-dose');
    const eveningSelect = newRow.querySelector('.evening-dose');
